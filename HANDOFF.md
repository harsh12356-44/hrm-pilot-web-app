...
26. **Strict HR Profile Switching Restriction**: Restricted account/profile switching strictly to HR Admin (`RK001` / Ravina Khimani / `ADMIN` role). Removed account switching capability for regular employee and manager logins.
